...
(function ( $ ) {
  ...
  $.fn.phonecalldisplay = function( options ) {
    ...
    const displayStyle = {'font-size': '40px', 'width': '330px', 'height': '80px', 'text-align': 'right', 'border-radius': '5pt', 'color': 'black'};
    ...
    const init = function() {
      ...
      const cellCallBtnNo2 = $('<td></td>').append($(callBtnNo2));
      const cellCallBtnNo3 = $('<td></td>').append($(callBtnNo3));
      const cellCallBtnNo4 = $('<td></td>').append($(callBtnNo4));
      const cellCallBtnNo5 = $('<td></td>').append($(callBtnNo5));
      const cellCallBtnNo6 = $('<td></td>').append($(callBtnNo6));
      const cellCallBtnNo7 = $('<td></td>').append($(callBtnNo7));
