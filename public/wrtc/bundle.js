...
},{"./utilmod.js":4}],2:[function(require,module,exports){
/* commonlib.js */
module.exports = function ( jq ) {
	const $ = jq;
...
},{"./video-stream-merger.js":5}],4:[function(require,module,exports){
/* utilmod.js */
...
},{"../../radio/mod/websocketmessage.js":8,"../../refer/mod/websocketmessage.js":9,"./websocketmessage.js":6}],5:[function(require,module,exports){
...
let userJoinOption = null;
let userMediaStream = null;
let displayMediaStream = null;
let localMergedStream = null;
let remoteConn = undefined;

const doSetupWsm = function(wsm) {
  wsm = wsm;
}
...
},{"./streammergermod.js":3}],8:[function(require,module,exports){
/* websocketmessage.js */
module.exports = function ( jq, wsm) {
	const $ = jq;
    ...
    if (data.type == 'test') {
      ...
      document.dispatchEvent(event);
			...
			switch(data.wrtc) {
				...
				case "offer":
					wrtcCommon.wsHandleOffer(data.offer);
				break;
				case "answer":
					wrtcCommon.wsHandleAnswer(data.answer);
				break;
				//when a remote peer sends an ice candidate to us
				case "candidate":
					wrtcCommon.wsHandleCandidate(data.candidate);
				break;
				case "leave":
					wrtcCommon.wsHandleLeave(data.leave);
				break;
			}
    }
  };
...
},{"../../case/mod/wrtc-common.js":7}],9:[function(require,module,exports){
/* websocketmessage.js */
module.exports = function ( jq, wsm ) {
	const $ = jq;
...
},{"../../case/mod/wrtc-common.js":7}],10:[function(require,module,exports){
/* main.js */
...
},{"../case/mod/commonlib.js":2,"../case/mod/utilmod.js":4,"./mod/streammergermod.js":11,"jquery":13}],11:[function(require,module,exports){
/* streammergermod.js */
const streamMerger = require('./video-stream-merger.js');
...
},{"./video-stream-merger.js":12}],12:[function(require,module,exports){
