  ...
  return new Promise(async function(resolve, reject) {
    ...
    const promiseList = new Promise(async function(resolve2, reject2) {
      cases.forEach(async (item, i) => {
        ...
        const radioData = {id: rades[0].id, User_NameTH: rades[0].User_NameTH, User_LastNameTH: rades[0].User_LastNameTH, username: radUser[0].username, email: radUser[0].User_Email, phone: radUser[0].User_Phone, sipphone: radUser[0].User_SipPhone};
