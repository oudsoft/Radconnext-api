  ...
  return new Promise(async function(resolve, reject) {
    ...
    const promiseList = new Promise(async function(resolve2, reject2) {
      cases.forEach(async (item, i) => {
        ...
        const radioData = {id: rades[0].id, User_NameTH: rades[0].User_NameTH, User_LastNameTH: rades[0].User_LastNameTH, username: radUser[0].username, email: rades[0].User_Email, phone: rades[0].User_Phone, sipphone: rades[0].User_SipPhone};
