...
const doExistUser = function(username){
  return new Promise(async function(resolve, reject) {
    ...
    const userInclude = [{ model: Hospital, attributes: excludeColumn}, {model: Usertype, attributes: excludeColumn}, {model: Userstatus, attributes: excludeColumn}, {model: Userinfo, attributes: excludeColumn}, { model: Hospital, attributes: excludeColumn}, {model: UserProfile, attributes: excludeColumn}];
    try {
